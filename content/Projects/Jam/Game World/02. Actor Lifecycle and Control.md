...
client에서 lifecycle create/meta/remove를 어떤 전송 계약으로 적용하고 snapshot과 어떻게 결합하는지는 [[../State Synchronization/02. Lifecycle and Snapshot Delivery|Lifecycle and Snapshot Delivery]]에서 설명합니다.

actor가 tick 안에서 처리되는 순서는 [[03. Authoritative Simulation|Authoritative Simulation]], visibility 변화는 [[04. Area of Interest Management|Area of Interest Management]]에서 설명합니다.

## Implementation References

- `JamNet/include/jamnet/runtime/world/actor/ActorId.h`
- `JamNet/include/jamnet/runtime/world/actor/ActorDirectory.h`
- `JamNet/src/runtime/world/actor/ActorDirectory.cpp`
- `JamNet/src/runtime/world/simulation/server/ServerWorld.cpp`
- `JamNet/include/jamnet/runtime/world/simulation/common/ActorComponents.h`
- `JamNet/include/jamnet/runtime/world/simulation/common/CharacterControlTypes.h`
- `JamNet/include/jamnet/runtime/world/simulation/common/CharacterControlResolver.h`
- `JamNet/src/runtime/world/simulation/common/CharacterControlResolver.cpp`
- `JamNet/src/runtime/world/simulation/client/ClientCharacterControlCoordinator.cpp`
- `JamNet/include/jamnet/runtime/world/simulation/server/ServerInputSystem.h`
- `JamNet/src/runtime/world/simulation/server/ServerInputSystem.cpp`
