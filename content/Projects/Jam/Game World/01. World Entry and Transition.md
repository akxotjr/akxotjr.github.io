...
actor와 control이 준비되는 과정은 [[02. Actor Lifecycle and Control|Actor Lifecycle and Control]]에서, initial visibility는 [[04. Area of Interest Management|Area of Interest Management]]에서, baseline과 initial sync 완료 조건은 [[../State Synchronization/03. Baseline and Delta State|Baseline and Delta State]]에서 이어집니다.


## Implementation References

- `JamNet/src/runtime/world/lifecycle/ServerWorldTransitionCoordinator.cpp`
- `JamNet/include/jamnet/runtime/world/lifecycle/ServerWorldTransitionCoordinator.h`
- `JamNet/include/jamnet/runtime/world/lifecycle/WorldTransitionTypes.h`
- `JamNet/include/jamnet/runtime/world/lifecycle/ClientMainWorldState.h`
- `JamNet/src/runtime/world/lifecycle/WorldShardState.cpp`
