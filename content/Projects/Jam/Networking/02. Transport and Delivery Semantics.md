...
이 문서는 contract의 의미와 선택 기준을 다룹니다. Reliable contract를 UDP 위에서 ACK, retransmission, congestion control로 구현하는 방법은 [[04. Reliable Datagram Delivery|Reliable Datagram Delivery]]에서 설명합니다.
