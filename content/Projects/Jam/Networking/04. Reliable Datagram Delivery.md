...
이 문서의 핵심 질문은 **“선택된 reliable delivery contract를 UDP 위에서 어떻게 구현하는가?”** 입니다. 어떤 application message가 reliable해야 하는지는 [[02. Transport and Delivery Semantics|Transport and Delivery Semantics]]에서 결정합니다. 여기서는 그 contract를 실현하는 sender/receiver state와 복구 메커니즘만 다룹니다.
...
- [[02. Transport and Delivery Semantics|Transport and Delivery Semantics]]
