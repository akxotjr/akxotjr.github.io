...
`GlobalExecutor`의 concurrency는 owner와 무관한 작업을 넓게 병렬화하기 위한 것입니다. 상태 변경의 ordering이 필요해지는 지점부터는 [[Projects/Jam/Execution Model/03. Owner-Local Serial Execution|Owner-Local Serial Execution]]으로 전환합니다.

thread 수와 affinity 구성은 [[Projects/Jam/Execution Model/06. Thread and Core Topology|Thread and Core Topology]]에서 설명합니다.
