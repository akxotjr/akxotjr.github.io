...
이 비용은 C++ runtime과 Unity authoring이 독립적으로 진화하면서도 같은 data contract를 유지하기 위한 선택입니다. 생성된 데이터가 runtime database로 변환되는 과정은 [[01. Shared Game Data|Shared Game Data]]에서 설명합니다.
