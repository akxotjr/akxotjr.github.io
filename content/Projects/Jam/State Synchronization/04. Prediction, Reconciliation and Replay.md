...
이 비용은 server authority를 유지하면서 local input의 체감 latency를 줄이기 위해 선택한 것입니다. physics replay의 실행 방식은 [[Projects/Jam/Physics/03. PhysX Integration and Scheduling|PhysX Integration and Scheduling]]에서 이어집니다.
...
- [Reconciliation과 replay 구현](https://github.com/akxotjr/Jam/blob/master/JamNet/src/runtime/world/simulation/client/ClientReplaySystem.cpp)
- [Authoritative correction 적용 진입점](https://github.com/akxotjr/Jam/blob/master/JamNet/src/runtime/world/simulation/client/ClientWorld.cpp)
- [Client prediction physics phase](https://github.com/akxotjr/Jam/blob/master/JamNet/include/jamnet/runtime/world/simulation/client/ClientPhysicsSystem.h)
- [Client replication 수신 상태](https://github.com/akxotjr/Jam/blob/master/JamNet/include/jamnet/runtime/world/simulation/client/ClientReplicationSystem.h)
