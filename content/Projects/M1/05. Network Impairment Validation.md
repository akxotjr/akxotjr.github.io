...
이 문서는 M1의 300 Bot gameplay workload에 의도적인 UDP network impairment를 적용해 reliable delivery와 replication recovery가 어떻게 동작하는지 확인한 결과를 정리합니다. Run 1은 `M1_Server_20260823_213143`, Run 2는 `M1_Server_20260823_211710`입니다.
...
| --- | --- | --- | --- |
| Run 2 (`211710`) | Inbound 5%, Outbound 5% | Off | Off |
| Run 1 (`213143`) | Inbound 5%, Outbound 5% | Inbound 50 ms, Outbound 50 ms | Inbound 10%, Outbound 10% |
...
| Metric | Run 2 — Drop 5% (`211710`) | Run 1 — Drop + Lag + OOO (`213143`) |
| --- | ---: | ---: |
